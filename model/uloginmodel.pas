...
begin
     ...
     try
       ...
       try
         ...
         begin
           status_code := 401;
           jsonObject.Add('message', 'Falha ao autenticar código no Google.');
         ...
         begin
           status_code := 401;
           jsonObject.Add('message', 'Falha ao obter dados do usuário do Google.');
           Exit(jsonObject.AsJSON);
         end;
         ...
         // -------------------------------------------------------------------------
         // ETAPA 3: Lógica de Banco de Dados Local (Inalterada)
         // -------------------------------------------------------------------------
         JsonData := TJSONObject.Create;
         try
